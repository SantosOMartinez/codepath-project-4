...
class HuntAnnotationView: MKAnnotationView {
    ...
    private func setupViews() {
        ...
        containerView.backgroundColor = UIColor(named: "secondaryBg")
        ...
        pointerView.backgroundColor = UIColor(named: "secondaryBg")
        pointerView.layer.cornerRadius = 8
